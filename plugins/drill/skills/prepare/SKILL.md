...
## 관련 Concept
- [~/Projects/til/spec/{feature}/concepts/{name}.md] — [설명]
...
- `~/Projects/til/spec/{feature-name}/SPEC.md` 읽기
- `~/Projects/til/spec/{feature-name}/concepts/*.md` 파일들 모두 읽기
...
- 목표 (Concept에서 도출)
- 관련 Concept 경로 (`~/Projects/til/spec/{feature}/concepts/{name}.md`)
...
- `~/Projects/til/spec/` 디렉토리에서 관련 스펙 검색 (Glob)
...
- **Concept 경로**: 티켓 내 Concept 링크는 `~/Projects/til/spec/{feature}/concepts/{name}.md` 형식
