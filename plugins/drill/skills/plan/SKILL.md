...
- **spec/concept** : 도메인 책임·약속·흐름. "X 를 할 수 있다", "Y 영역에서 다룬다" 수준의 **모호성이 의도된 자유도로 허용된다**
- **decision** : spec 의 미결·논쟁을 닫는 확정. 위치·매체·옵션 카탈로그는 다루지 않는다
- **ticket** (prepare 산출물): 위치·매체·선택지 우선순위·구체 옵션·시그니처. spec 의 약속을 충족하는 구체 구현 결정
