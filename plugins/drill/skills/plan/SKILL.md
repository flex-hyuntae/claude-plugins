...
- **how·옵션 우선순위 질문 금지** — "어떻게 / 어디서 / 어떤 매체로 / 어떤 항목으로 / 어떤 prop 으로 / size·navigator·count 중 본 사이클" 같은 how·선택지 우선순위 차원은 묻지 않는다. 본 단계는 **what / why** 만 (§Layer 경계 참고). plan 에서는 "X 를 사용한다 / 할 수 있다" 까지만 약속. 사용자가 how 답을 자발적으로 던지면 "그건 prepare 에서 ticket 본문으로 다룸" 안내 후 what/why 로 회귀
