...
- **concept_patches 작성 시 노출 매체·구현 동사 금지** — "Popover Callout 추가" / "Modal → Popover 전환" / "토스트가 뜬다" 같은 표현은 concept 본문에 박지 않는다. 도메인 동사("연결한다" / "확정된다") 와 단일 source 분류만. 자가 점검 키워드: Popover / Modal / Dialog / Toast / Sheet / Tooltip / "뜬다" / "열린다"
